...
export const SITE_MESSAGES: Record<Locale, SiteMessages> = {
  en: {
    ...
    homeF1Description:
      "League standings, analysis, and prediction insights for my F1 Fantasy league.",
    homeF1Cta: "View dashboard",
    homePodcastTitle: "Podcast",
    homePodcastDescription: "F1, other sports, personal life, intellectual pleasure, and pulp fiction.",
    homePodcastCta: "Listen now",
    homeBlogTitle: "Blog",
    homeBlogDescription: "Notes, and my feelings.",
    homeBlogCta: "Read posts",

    podcastEyebrow: "Podcast",
    podcastName: "Aasuka Cosmos",
    podcastIntro:
      "A place for a chronic talker to get some words out. Whatever I'm into — F1, other sports, my personal life, games, and all interesting stuff.",
    ...
    blogEyebrow: "Blog",
    blogTitle: "Writing",
    blogDescription: "Notes, and occasional long-form thinking.",
  ...
  zh: {
    ...
    homeF1Title: "F1 Fantasy",
    homeF1Description: "我的 F1 Fantasy 联盟排名、分析与预测。",
    homeF1Cta: "查看仪表盘",
    homePodcastTitle: "播客",
    homePodcastDescription: "F1，体育，个人生活，智力游戏，与低俗爱好。",
    homePodcastCta: "立即收听",
    homeBlogTitle: "博客",
    homeBlogDescription: "笔记，与随想。",
    homeBlogCta: "阅读文章",

    podcastEyebrow: "播客",
    podcastName: "鳥舍雜俎",
    podcastIntro:
      "这是一个话痨独在异乡缓解表达欲的地方。感兴趣的话题都会聊聊——F1和其他体育、异乡生活、人间观察...",
